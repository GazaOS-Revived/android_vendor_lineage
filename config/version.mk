...
MATRIXX_VERSION := 11.6.0

MATRIXX_RELEASE_CODE := Trigon
...
# Internal version
LINEAGE_VERSION := GazaOS$(MATRIXX_VARIANT)-v$(MATRIXX_VERSION)-$(MATRIXX_BUILD_TYPE)-$(LINEAGE_BUILD)-$(MATRIXX_BUILD_VARIANT)-$(shell date +%Y%m%d%H%M)
